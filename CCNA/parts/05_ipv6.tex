...
separated by colons. If hexadecimal is not yet automatic, the two-minute primer
in \chref{ethernet} is the one thing to re-read before going on --- this whole
chapter is written in it, and modified EUI-64 below cannot be followed without
being able to expand one hex digit into four bits.

Two rules compress it.
