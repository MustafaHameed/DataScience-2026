...
\end{tikzpicture}}%
{The whole idea, in one picture. Four ports on one switch become two broadcast
domains that cannot reach each other --- and nothing physical changed.}{vlansplit}
