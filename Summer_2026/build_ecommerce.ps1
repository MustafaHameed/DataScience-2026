# Build the Summer 2026 E-commerce Application Development handout.
#   .\build_ecommerce.ps1          normal build
#   .\build_ecommerce.ps1 -Clean   remove aux files first
param([switch]$Clean)

$ErrorActionPreference = 'Stop'
Set-Location $PSScriptRoot
$main = 'Ecommerce_Handout'
