# Build the Urdu brief edition of the AIOU 1431 Basics of ICT course guide.
...
Write-Host ''
Write-Host '--- Build report (1431 Urdu brief) ---' -ForegroundColor Cyan
