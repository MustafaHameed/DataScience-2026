...
The standalone preamble is *generated from dshandout.sty* on every run -- the
...
STY = os.path.join(ROOT, "dshandout.sty")
...
# ---------------------------------------------------------------------------
# Preamble, generated from dshandout.sty
# ---------------------------------------------------------------------------
...
def preamble() -> str:
    ...
    lines += [
        "% --- colours, lifted from dshandout.sty",
        colours,
