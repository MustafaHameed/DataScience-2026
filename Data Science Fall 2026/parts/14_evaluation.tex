...
\node[font=\scriptsize\bfseries, text=primary] at (1.4,1.9) {Positive};
\node[font=\scriptsize\bfseries, text=primary] at (4.6,1.9) {Negative};
...
\node[anchor=north west, align=left, text width=7.6cm] at (6.5,2.1) {%
...
\node[anchor=north, align=left, text width=13.2cm, font=\scriptsize, text=gray!55!black] at (5.0,-2.8)
...
\node[font=\tiny, accent, anchor=south west, rotate=90] at (axis cs:0.5,0.06) {default 0.5};
...
% y = x^a has AUC 1/(1+a): a = 1/9 gives 0.90, a = 3/7 gives 0.70
\addplot[greenhl, line width=1.4pt, domain=0:1, samples=160] {x^(1/9)};
\addlegendentry{good (AUC 0.90)}
\addplot[goldhl, line width=1.2pt, domain=0:1, samples=160] {x^(3/7)};
\addlegendentry{fair (AUC 0.70)}
\addplot[accent, only marks, mark=*, mark size=1.7pt] coordinates {(0.011,0.80)};
\draw[accent, line width=0.4pt] (axis cs:0.014,0.775) -- (axis cs:0.05,0.655);
\node[font=\tiny, accent, anchor=north west, inner sep=1pt] at (axis cs:0.045,0.655) {worked example};
...
\foreach \r in {1,...,5}{
  ...
  \node[anchor=east, font=\tiny, text=gray!55!black] at (-1.15,\yy) {fold \r};
  \foreach \c in {1,...,5}{
    ...
    \fi}
  \node[anchor=west, font=\tiny, text=gray!55!black] at (9.72,\yy)
       {score$_\r$};}

\draw[decorate, decoration={brace, amplitude=4pt}, gray!60]
     (10.85,0.3) -- (10.85,-3.18)
...
\node[anchor=north west, align=left, text width=10.5cm, font=\scriptsize, text=accent!75!black]
     at (-1.1,-3.75)
...
\begin{longtable}{@{}L{3.6cm}L{5.0cm}L{5.9cm}@{}}
\toprule
\rowcolor{primary!15}
...
for t in np.linspace(0.01, 0.95, 95):
    ...
    _, fp_, fn_, _ = confusion_matrix(y_te, p).ravel()
