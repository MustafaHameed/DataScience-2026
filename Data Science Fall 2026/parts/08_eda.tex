...
\begin{tikzpicture}[font=\scriptsize,
  ...
  rh/.style={rounded corners=2pt, fill=primary!75, text=white,
             text width=2.4cm, align=center, minimum height=1.25cm, font=\scriptsize\bfseries}]
...
\node[rh] at (-0.35,-2.85) {CATEGORICAL};
...
\begin{longtable}{@{}p{4.2cm}p{5.2cm}p{5.1cm}@{}}
\toprule
\rowcolor{primary!15}
