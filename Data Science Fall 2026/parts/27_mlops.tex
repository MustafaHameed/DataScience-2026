...
\node[anchor=west, align=left, text width=13.8cm, font=\tiny, text=accent!75!black]
     at (-1.5,-3.4)
...
\node[rounded corners=4pt, draw=primary, fill=primary!8, text=primary,
      text width=12.6cm, align=center, font=\tiny\bfseries, minimum height=0.62cm]
      (run) at (5.5,-1.5) {RUN ID 2026-08-01-a41f  ---  one identifier binds all five};
\foreach \n in {c,d,e,p,m}{
  \draw[-{Stealth[length=1.6mm]}, primary!45] (\n) -- (run);}

\node[anchor=west, align=left, text width=13.4cm, font=\tiny, text=gray!55!black]
     at (-1.3,-2.5)
...
\node[anchor=west, align=left, text width=13.4cm, font=\scriptsize, text=accent!75!black]
     at (-3.35,-6.5)
