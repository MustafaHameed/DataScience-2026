...
\node[font=\tiny\itshape, text=gray!55!black, anchor=north, align=center, text width=11cm]
     at (3.9,-2.0)
...
\node[anchor=west, align=left, text width=13.2cm, font=\tiny, text=primary!60!black]
     at (-1.0,-3.6)
