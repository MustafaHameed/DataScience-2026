...
\begin{longtable}{@{}p{2.9cm}p{5.0cm}p{6.7cm}@{}}
\toprule
\rowcolor{primary!15}
...
\begin{longtable}{@{}p{3.3cm}p{4.6cm}p{6.6cm}@{}}
\toprule
\rowcolor{primary!15}
...
\node[align=left, text width=13.5cm, font=\scriptsize, text=accent!70!black] at (4.6,-3.2)
...
\rowcolors{2}{white}{lightbg}
\begin{longtable}{@{}p{4.4cm}p{4.6cm}p{5.5cm}@{}}
\toprule
\rowcolor{primary!15}
