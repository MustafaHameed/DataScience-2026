...
\begin{longtable}{@{}L{3.1cm}L{4.6cm}L{6.5cm}@{}}
\toprule
\rowcolor{primary!15}
...
% This section opens straight into a tall figure, so it needs real room below
% the heading; without the guard the figure lands at the foot of the page and
% prints over the footer rule.
...
\node[anchor=north west, align=left, text width=13.0cm, font=\scriptsize, text=accent!75!black]
     at (-0.8,-4.1)
...
\node[anchor=north west, align=left, text width=13.0cm, font=\scriptsize, text=gray!55!black]
     at (-0.6,-2.75)
