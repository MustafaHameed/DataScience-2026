...
\node[rounded corners=3pt, draw=tealhl, fill=tealhl!8, text=tealhl!50!black,
      text width=12.6cm, align=center, font=\tiny, minimum height=0.65cm] at (5.4,-3.1)
...
\node[anchor=west, align=left, text width=13.4cm, font=\scriptsize, text=primary!60!black]
     at (-1.9,-3.5)
...
\begin{longtable}{@{}p{2.7cm}p{4.4cm}p{6.9cm}@{}}
\toprule
\rowcolor{primary!15}
