...
Five late-task classifiers, each 70\% accurate, with independent errors. The
majority is right when at least three are right:
\[
...
Part 2 uses 3{,}000 synthetic past tasks, each described by twenty numeric
features, of which 5\% were recorded with the wrong outcome.
