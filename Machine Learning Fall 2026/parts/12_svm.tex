...
by cross-validation. On the 600 projects of \chref{knn}'s lab this finds $C = 100$,
$\gamma = 0.01$ and 93.2\% accuracy --- better than the best $k$-NN --- using 183
of the projects as support vectors. $C$ landed on the edge of the grid, so the
next step would be to extend the grid upwards.
\end{alertbox}
