...
X, y = data.data, 1 - data.target           # 1 = malignant: must not miss
...
card = {
    ...
    "intended use": "second reader for tumour measurements; never alone",
    "data": f"Wisconsin breast cancer, {len(y)} cases, 30 features",
    ...
    "limitations": "one hospital's data; not validated on other scanners",
