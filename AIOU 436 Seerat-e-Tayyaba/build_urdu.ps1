# Build the Urdu brief edition of the AIOU 436 Seerat-e-Tayyaba course guide.
...
Write-Host ''
Write-Host '--- Build report (436 Urdu brief) ---' -ForegroundColor Cyan
