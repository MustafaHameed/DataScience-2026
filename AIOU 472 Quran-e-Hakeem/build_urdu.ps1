# Build the Urdu brief edition of the AIOU 472 Quran-e-Hakeem course guide.
...
Write-Host ''
Write-Host '--- Build report (472 Urdu brief) ---' -ForegroundColor Cyan
