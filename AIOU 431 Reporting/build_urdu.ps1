# Build the Urdu brief edition of the AIOU 431 Reporting course guide.
...
Write-Host ''
Write-Host '--- Build report (431 Urdu brief) ---' -ForegroundColor Cyan
