...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \fill[bmaccent] ([yshift=-8.6cm]current page.north west) rectangle
        ([yshift=-8.8cm]current page.north east);
\end{tikzpicture}
...
{\color{white}
  ...
  \vspace{6pt}
  {بی اے \ \textbullet\ \ بی کام \ \textbullet\ \ اے ڈی سی \ \textbullet\ \ بی ایس}
}
