# Build the AIOU 1429 Business Mathematics solved question bank.
...
$main = 'AIOU_1429_Solved_QuestionBank'
...
function Invoke-Latexmk {
    ...
    try {
        ...
        # that routine progress notes are not rendered as red error blocks;
